package net.shadowpie.sadiinso.snowflakecore.snowflakecore;
...
import net.shadowpie.sadiinso.snowflakecore.commands.base.BaseCommands;
import net.shadowpie.sadiinso.snowflakecore.commands.base.HelpCommand;
import net.shadowpie.sadiinso.snowflakecore.commands.base.PermissionCommands;
import net.shadowpie.sadiinso.snowflakecore.config.ConfigHandler;
import net.shadowpie.sadiinso.snowflakecore.db.DB;
import net.shadowpie.sadiinso.snowflakecore.listeners.ConsoleListener;
import net.shadowpie.sadiinso.snowflakecore.listeners.SFCListener;
import net.shadowpie.sadiinso.snowflakecore.permissions.Permissions;
import net.shadowpie.sadiinso.snowflakecore.webapi.WebAPI;
...
public class SFC {
	...
	public static void init(String configFile) {
		...
		//INIT LISTENERS
		//##############
		jda.addEventListener(new SFCListener());
